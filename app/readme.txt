...
Будет плюсом, если стили будут написаны с использованием SASS, а JS - на ES6 с использованием феймфорка Vue.js.
Это не обязательное требование, но именно с этим придется работать в случае найма. Если не Vue.js, тогда чистый JS.
Bootstrap и другие подобные CSS-фреймворки не использовать.

Все должно хорошо выглядеть и работать в последних версиях современных бруазеров и IE11.
